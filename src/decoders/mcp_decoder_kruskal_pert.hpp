#ifndef MCP_DECODER_KRUSKAL_PERTUBATION_HPP_
#define MCP_DECODER_KRUSKAL_PERTUBATION_HPP_
...
class MCP_Decoder_Kruskal_Pertubation {
public:
...
public:
    ...
    MCP_Decoder_Kruskal_Pertubation(const MCP_Instance& instance);
